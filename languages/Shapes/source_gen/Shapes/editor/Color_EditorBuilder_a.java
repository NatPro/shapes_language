...
/*package*/ class Color_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  /*package*/ EditorCell createCell() {
    return createCollection_abwbgk_a();
  }

  private EditorCell createCollection_abwbgk_a() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_abwbgk_a");
    editorCell.setBig(true);
    editorCell.setCellContext(getCellFactory().getCellContext());
    editorCell.addEditorCell(createConstant_abwbgk_a0());
    editorCell.addEditorCell(createProperty_abwbgk_b0());
    return editorCell;
  }
  private EditorCell createConstant_abwbgk_a0() {
  ...
  private EditorCell createProperty_abwbgk_b0() {
